#FILE OF CONSTANTS ACROSS ALL SCRIPTS
...
#Database constants:
databaseName = 'ArtistScrape.db' #must end in .db
tableName = 'ArtistInfo'

#Excel constants:
xlFileName = 'ArtistScrape.xlsx'

#List of Valid Country Codes
#   Commented codes are ones that yielded errors when used in the spotify search function
countryCodes = [
    'US',
    'AD',
    'AE',
...
genreList = [
    ...
    'Danish Indie',
    'Danish Jazz',
    'Danish Pop','Danish Pop Rock','Dansband',
    'Danseband',
    'Dansktop',
    'Dark Ambient',
    'Dark Black Metal',
